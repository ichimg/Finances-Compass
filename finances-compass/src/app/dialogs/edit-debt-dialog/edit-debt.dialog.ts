...
@Component({
  ...
  templateUrl: './edit-debt.dialog.html',
  styleUrls: ['./edit-debt.dialog.css'],
  providers: [
    {
      provide: DateAdapter,
...
export class EditDebtDialog implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<EditDebtDialog>,
